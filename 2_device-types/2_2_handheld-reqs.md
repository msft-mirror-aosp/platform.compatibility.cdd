...
*   [[7.1](#7_1_display_and_graphics).4.5/H-1-1] MUST advertise support for the
...
*   [[7.6](#7_6_memory_and_storage).1/H-9-1] MUST declare the feature flag
    [`android.hardware.ram.low`](
    https://developer.android.com/reference/android/content/pm/PackageManager.html#FEATURE_RAM_LOW).
*   [[7.6](#7_6_memory_and_storage).1/H-9-2] MUST have at least 1.1 GB of
...
*   [[7.6](#7_6_memory_and_storage).1/H-10-1] MUST have at least 4GB of
...
*    [[5.1](#5_1_media_codecs).1/H-0-5] AAC ELD (enhanced low delay AAC)
...
*   [[3.8](#3_8_user_interface_compatibility).2/H-SR] Are STRONGLY RECOMMENDED
to support third-party app widgets.
*   [[3.8](#3_8_user_interface_compatibility).3/H-0-1] MUST allow third-party
