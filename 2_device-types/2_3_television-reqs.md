...
*   [[5.3.5](#5_3_video-decoding).5/T-2-1] MUST support the UHD decoding profile at 60 frames per second with Main10 Level 5
Main Tier profile.
...
*   [[5.3.7](#5_3_video-decoding).5/T-2-1] MUST support the UHD decoding profile 
at 60 frames per second with profile 0 (8 bit colour depth).
*   [[5.3.7](#5_3_video-decoding).5/T-2-1] Are STRONGLY RECOMMENDED to support the UHD decoding profile 
